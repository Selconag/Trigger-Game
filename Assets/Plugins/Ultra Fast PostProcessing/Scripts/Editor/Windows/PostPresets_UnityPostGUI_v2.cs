...
//      {
//          public const string TITLE = "Unity PostProcessing [FREE]";
...
//                      profile = (UnityEngine.Rendering.PostProcessing.PostProcessProfile)volume.sharedProfile;
//                  }
//                  else profile = null;
//  #endif
//              }
...
//          Dictionary<int, UnityEditor.Editor> p_to_e = new Dictionary<int, UnityEditor.Editor>();
//  
...
//  #if UNITY_POST_PROCESSING_STACK_V2
//              var volume = (UnityEngine.Rendering.PostProcessing.PostProcessVolume)((ISupportedPostComponent)this).MonoComponent;
//              profile = volume.sharedProfile = (UnityEngine.Rendering.PostProcessing.PostProcessProfile)__profile;
//  #endif
//  
//  
//              ResetEditor();
...
//              //  var so = profile ? new SerializedObject(profile) : null;
//              try
//              {
//                  e.OnInspectorGUI();
//  
...
//              // if (GUI.changed && so != null) so.ApplyModifiedProperties();
...
//              result.enabled = true;
//  
//              // UnityEngine.Rendering.PostProcessing.Bloom b = null;
//              var serializedObject = new SerializedObject(result.target);
//              var i1 = serializedObject.FindProperty("intensity.overrideState");
//              var i2 = serializedObject.FindProperty("intensity.value");
//              if (i1 != null && i2 != null)
//              {
//                  i1.boolValue = true;
//                  i2.floatValue = 2;
...
//                  {
//                      if (item.Value)
//                          if (Application.isPlaying) UnityEditor.Editor.Destroy(item.Value);
//                          else UnityEditor.Editor.DestroyImmediate(item.Value, false);
//                  }
//                  p_to_e.Clear();
...
//                      var m_Enabled = serializedObject.FindProperty("enabled.value");
//                      var m_Enabled2 = serializedObject.FindProperty("enabled.overrideState");
//                      if (value) m_Enabled.boolValue = value;
//                      if (value) m_Enabled2.boolValue = value;
//                      m_Enabled3.boolValue = value;
//                      serializedObject.ApplyModifiedProperties();
//                  }
//              }
...
//                      {
//                          var guid = EditorPrefs.GetString("EMX/" + Params.TITLE + "/LastProfilesv2" + i, "");
...
//                      if (string.IsNullOrEmpty(guid)) continue;
//                      EditorPrefs.SetString("EMX/" + Params.TITLE + "/LastProfilesv2" + i, guid);
//                  }
//                  _mLastList = value;
//              }
//          }
...
//              if (profile && AssetDatabase.GetAssetPath(profile).StartsWith("Assets")) SET_PROFILE(comp, profile);
